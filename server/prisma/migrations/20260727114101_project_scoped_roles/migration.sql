...
-- CreateEnum
CREATE TYPE "FileType" AS ENUM ('PDF', 'IMAGE', 'DOCX');
...
-- AddForeignKey
ALTER TABLE "ProjectMember" ADD CONSTRAINT "ProjectMember_invitedBy_fkey" FOREIGN KEY ("invitedBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
